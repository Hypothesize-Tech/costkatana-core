...
export const COHERE_PRICING: ModelPricingConfig[] = [
  // Generative Models
  {
    ...
    isLatest: true,
    notes:
      'Most efficient and performant model to date, specializing in agentic AI, multilingual, and human evaluations for real-life use cases'
  },
  {
    ...
    isLatest: true,
    notes:
      'Powerful, scalable large language model purpose-built to excel at real-world enterprise use cases'
  },
  {
    modelId: 'command-r',
    modelName: 'Command R',
  ...
  // Retrieval Models
  {
    ...
    isLatest: true,
    notes:
      'Provides a powerful semantic boost to the search quality of any keyword or vector search system. $2.00 per 1K searches (query with up to 100 documents)'
  },
  {
    modelId: 'embed-4',
    modelName: 'Embed 4',
    ...
    isLatest: true,
    notes:
      'Leading multimodal embedding model. Acts as an intelligent retrieval engine for semantic search and RAG systems. Image: $0.47/1M image tokens'
  },
